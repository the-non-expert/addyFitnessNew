...
>
  <svg
    class="w-8 h-8 text-white shrink-0 ml-3"
    fill="currentColor"
    viewBox="0 0 24 24"
  >
    <path
  ...
  <p
    class="text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 ml-4 whitespace-nowrap font-medium"
  >
    An Agent will be there with you in a moment
  </p>
</a>
